...
const projectFile = {
    description: {
        name: 'lumi.🎒attack.eth', //Will appear in the Navbar and Footer
        token: '🎒', //the name of the token
        tokenSymbol: '🎒', //the name of the token
        tokenPlural: 'Lumi🎒', //the plural name of the token
        authors: [
            //any authors
            ...
            {
                Name: 'Lumi Paradox',
                role: 'The Paradox of the Lumi',
                url: 'https://lumiparadox.com/',
                twitter: 'LumiParadox',
            },
        ],
        //goes inside of the tokenURI
        tokenName: 'Lumi🎒Backpack',
        tokenDescription: `This is the official Onchain 🎒Backpack of the Lumi!`,
    },
    //@ means will reference files inside of react build
    static: {
        logo: 'lumi/logo.png',
        background: 'lumi/background.png',
        headerBackground: 'lumi/background.png',
        backgroundColour: '#fabf09',
        stylesheets: ['styles/bootstrap.lumi.css', '@Resources/app.css'],
        images: {
            features: 'lumi/logo.png',
            loading: 'lumi/loading.gif',
            texture: 'lumi/background.png',
            teamDefaultIcon: '@Images/person.png',
            noWeb3: '@Images/missingWeb3.png',
            loadingComponent: 'lumi/loading.gif',
        },
    },
    deployment: {
